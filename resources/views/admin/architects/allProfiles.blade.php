      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a>Profiles</a> </li>
            <li class="active"> <strong> Pending Profiles </strong> </li>
          </ol>
        </div>
      </div>
      <div class="row">
                  ...
                  <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href ="/admin/view-architectProfile/{{$profile->architect_id}}" target="_blank">View</a></td>
                        <td>@if($profile->status == 0)
                            ...
                            <div class="btn-group">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                  <li>
                                      <form action="/admin/approve-profile/{{$profile->id}}" method="POST" enctype="multipart/form-data">
                                  ...
                                  <li> <form action="/admin/reject-profile/{{$profile->id}}" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_method" value="PUT">
                                    <input type="hidden" name="id" value="{{$profile->id}}">
                                  @csrf
