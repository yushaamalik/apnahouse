...
<head>
    ...
    <title>ApnaHouse | {{Auth::guard('admin')->user()->name}}</title>
    <!-- Bootstrap -->
        ...
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar">
                <ul class="page-sidebar-menu  page-header-fixed ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-th-large"></i> <span class="title">Architects Profiles</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('admin.architect.pendingProfiles')}}"> <span class="title">Pending Profiles</span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('admin.architect.allProfiles')}}"><span class="title">All Profiles </span> </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('admin.plan.pendingPlans')}}"> <span class="title">Pending Plans</span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('admin.plan.allPlans')}}"><span class="title">All Plans </span> </a>
                            </li>
                        </ul>
                    </li>
                    {{-- <li class="nav-item">
