              ...
              <div class="widgets-container">
                ...
                <form action="{{route('architect.profile.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" class="iCheck" checked="" value="1" id="optionsRadios22" name="company_incorp">Yes</label>
                    <label class="mt-radio">
                    <input type="radio" class="iCheck" checked="" value="0" id="optionsRadios22" name="company_incorp">No </label>
                  </div>
                ...
                @elseif($architectProfile->status == 1)
                <h5>Profile Submitted </h5>
                Status = <strong> Pending
                @elseif($architectProfile->status == 2)
                <h5>Profile Submitted </h5>
                Status = <strong> Approved
                @elseif($architectProfile->status == 3)
                <h5>Profile Submitted </h5>
