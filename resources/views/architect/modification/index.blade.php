              ...
              <div class="widgets-container">
                <div >
                  <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                    ...
                    <tbody>
                        @foreach($modificationRequests as $request)
                      <tr>
                        <td>{{$request->id}}</td>
                        ...
                        <td>{{$request->title}}</td>
                        {{-- <td>{{$request->architect()->first()->name}}</td> --}}
                        <td>{{$request->plan()->first()->plan_name}}</td>
                        <td><a href ="modification-request-view/{{$request->user_id}}/{{$request->plan_id}}/{{$request->id}}" target="_blank">View</a></td>
                        {{-- <td><a href="#">View</a></td> --}}
