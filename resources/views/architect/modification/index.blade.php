  ...
  <div class="page-content-wrapper animated fadeInRight">
    <div class="page-content">
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          <h2> All Modification Requests </h2>
          <ol class="breadcrumb">
            <li> <a href="{{ route('architect.dashboard') }}">Home</a> </li>
            <li> <a>Plans</a> </li>
            <li class="active"> <strong> All Modification Requests </strong> </li>
          </ol>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
            <div class="ibox-title">
              <h5>All Modification Requests List</h5>
            </div>
                    ...
                    <tbody>
                      @foreach ($modifications as $m)
                        <tr>
                          ...
                          <td>{{ $m->title }}</td>
                          {{-- <td>{{$m->architect()->first()->name}}</td> --}}
                          <td>{{ $m->plan()->first()->plan_name }}</td>
                          <td><a
                              href="modification-request-view/{{ $m->user_id }}/{{ $m->plan_id }}/{{ $m->id }}"
  ...
  @section('js')
    ...
    <script>
      var dataSet = [
        ...
        ["Auckland Straight Line Host", "Junior Technical Author", "San Francisco", "1562", "2009/01/12",
          "$86,000"
        ],
      ...
      $(document).ready(function() {
        ...
        $('#example6 tfoot th').each(function() {
          var title = $(this).text();
          $(this).html('<input class="form-control dataSearch" type="text" placeholder="Search ' +
            title + '" />');
        });
