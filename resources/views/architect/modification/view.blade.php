              ...
              <div class="ibox">
                <div class="ibox-title">
                    ...
                    @if($message->receiver_id == $userId)
                        <li><strong>User </strong> : {{$message->body}} <div class="text-right"><small> Sent at : {{$message->created_at}}</small></div></li>
                        @else
                        <li><strong>You </strong> : {{$message->body}} <small> Received at :  {{$message->created_at}}</small></li>
                    @endif
                    @endif
                    @endif
                    @endforeach
