...
<!-- Mirrored from adminui-v1.0.bittyfox.com/default/aqua-black/{{route('home')}} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 15:58:06 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>ApnaHouse | {{Auth::guard('web')->user()->name}}</title>
    <!-- Bootstrap -->
...
<body class="page-header-fixed ">
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            <!-- BEGIN LOGO -->
            <div class="page-logo">
                <a href="{{route('home')}}"> <h2 style="margin-left: 20px; padding-bottom:20px;"> Home  </h2> </a>
            </div>
...
<!--  TOP NAVIGATION MENU -->
                <div class="hor-menu  hor-menu-light hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="classic-menu-dropdown active"> <a href="{{route('home')}}"><i class="icon-user fa-fw"></i></a> </li>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a data-close-others="true" data-hover="dropdown" data-toggle="dropdown" class="dropdown-toggle" href="javascript:;"> <img src="/admin/assets/images/teem/" class="img-circle" alt=""> <span class="username username-hide-on-mobile"> {{Auth::guard('web')->user()->name}}</span> <i class="fa fa-angle-down"></i> </a>
        ...
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar">
                <ul class="page-sidebar-menu  page-header-fixed ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('pages.index')}}"> <i class="fa fa-th-large"></i> <span class="title">Visit Website</span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('home')}}"> <i class="fa fa-th-large"></i> <span class="title">Dashboard</span> </a>
                    </li>
                    <li class="heading">
                        <h3 class="uppercase">Control</h3>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-th-large"></i> <span class="title">My Orders</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="#"> <span class="title">All Orders</span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><span class="title">Favorites </span> </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="#"> <span class="title">Pending Plans</span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><span class="title">All Plans </span> </a>
                            </li>
                        </ul>
                    </li>
                    {{-- <li class="nav-item">
...
<!-- Mirrored from adminui-v1.0.bittyfox.com/default/aqua-black/{{route('home')}} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 16:02:06 GMT -->
</html>